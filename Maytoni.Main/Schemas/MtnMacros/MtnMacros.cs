namespace BPMSoft.Configuration
{
    ...
    public class MtnEstimateLinksGenerator : IMacrosInvokable
    {
        ...
        public MtnEstimateLinksGenerator()
        {
        }

        public MtnEstimateLinksGenerator(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public virtual string GetMacrosValue(object arguments)
        {
            ...
            var points = new int[] { 5, 4, 3 };
            esq.Filters.Add(esq.CreateFilterWithParameters(FilterComparisonType.Equal, "Point", points));
